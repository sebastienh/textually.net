...
export default class StyloDocumentationEssentialsSideMenu extends Component {
            ...
            <MenuContainer>
                ...
                <LinksContainer>
                    ...
                    <MainLink
                        ...
                        href='/stylo/documentation/stylo-essentials#essentials'
                        number={1}
                        p={2}>
                        Introduction
                    </MainLink>
                    ...
                    <MainLink
                        path={["/", "stylo", "documentation", "stylo-essentials"]}
                        href='/stylo/documentation/stylo-essentials#sidebar'
                        number={4}
                        p={2}>
                        Sidebar
                    </MainLink>
